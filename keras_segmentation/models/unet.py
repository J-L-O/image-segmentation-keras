...
from keras_segmentation.models.panoramic_layers import Conv2DPano, MaxPooling2DPano
...
def unet_mini(n_classes, input_height=360, input_width=480):
    ...
    conv1 = Conv2DPano(32, (3, 3), data_format=IMAGE_ORDERING,
                   activation='relu', padding='same')(img_input)
    conv1 = Dropout(0.2)(conv1)
    conv1 = Conv2DPano(32, (3, 3), data_format=IMAGE_ORDERING,
                   activation='relu', padding='same')(conv1)
    pool1 = MaxPooling2DPano((2, 2), data_format=IMAGE_ORDERING)(conv1)

    conv2 = Conv2DPano(64, (3, 3), data_format=IMAGE_ORDERING,
                   activation='relu', padding='same')(pool1)
    conv2 = Dropout(0.2)(conv2)
    conv2 = Conv2DPano(64, (3, 3), data_format=IMAGE_ORDERING,
                   activation='relu', padding='same')(conv2)
    pool2 = MaxPooling2DPano((2, 2), data_format=IMAGE_ORDERING)(conv2)

    conv3 = Conv2DPano(128, (3, 3), data_format=IMAGE_ORDERING,
    ...
    conv4 = Conv2DPano(64, (3, 3), data_format=IMAGE_ORDERING,
    ...
    conv5 = Conv2DPano(32, (3, 3), data_format=IMAGE_ORDERING,
                   activation='relu', padding='same')(up2)
    conv5 = Dropout(0.2)(conv5)
    conv5 = Conv2DPano(32, (3, 3), data_format=IMAGE_ORDERING,
                   activation='relu', padding='same')(conv5)

    o = Conv2DPano(n_classes, (1, 1), data_format=IMAGE_ORDERING,
               padding='same')(conv5)
...
def _unet(n_classes, encoder, l1_skip_conn=True, input_height=416,
    ...
    o = (ZeroPadding2D((1, 1), data_format=IMAGE_ORDERING))(o)
    o = (Conv2DPano(128, (3, 3), padding='valid', data_format=IMAGE_ORDERING))(o)
    o = (BatchNormalization())(o)
